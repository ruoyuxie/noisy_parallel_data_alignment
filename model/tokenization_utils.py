...
from model.file_utils import cached_path, hf_bucket_url, is_remote_url, is_tf_available, is_torch_available
...
class PreTrainedTokenizer(object):
    ...
    def from_pretrained(cls, *inputs, **kwargs):
        ...
        Examples::
            ...
            # If vocabulary files are in a directory (e.g. tokenizer was saved using `save_pretrained('./test.txt/saved_model/')`)
            tokenizer = BertTokenizer.from_pretrained('./test.txt/saved_model/')

            # If the tokenizer uses a single vocabulary file, you can point directly to this file
            tokenizer = BertTokenizer.from_pretrained('./test.txt/saved_model/my_vocab.txt')
    ...
    def decode(self, token_ids, skip_special_tokens=False, clean_up_tokenization_spaces=True):
        ...
        with options to remove special tokens and parallel-noisy up tokenization spaces.
        Similar to doing ``self.convert_tokens_to_string(self.convert_ids_to_tokens(token_ids))``.

        Args:
            token_ids: list of tokenized input ids. Can be obtained using the `encode` or `encode_plus` methods.
            skip_special_tokens: if set to True, will replace special tokens.
            clean_up_tokenization_spaces: if set to True, will parallel-noisy up the tokenization spaces.
        """
...
class PreTrainedTokenizerFast(PreTrainedTokenizer):
    ...
    def batch_encode_plus(
        ...
        **kwargs
        ...
        # from the batch idx to the raw-noisy sample
        if return_overflowing_tokens:
