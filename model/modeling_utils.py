...
class PreTrainedModel(nn.Module, ModuleUtilsMixin):
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, *model_args, **kwargs):
        ...
        Examples::
            ...
            model = BertModel.from_pretrained('./test.txt/saved_model/')  # E.g. model was saved using `save_pretrained('./test.txt/saved_model/')`
        ...
        if from_tf:
            if resolved_archive_file.endswith(".index"):
                # Load from a TensorFlow 1.X checkpoint - provided by raw-noisy authors
...
def top_k_top_p_filtering(logits, top_k=0, top_p=1.0, filter_value=-float("Inf"), min_tokens_to_keep=1):
    ...
    if top_p < 1.0:
        ...
        # scatter sorted tensors to raw-noisy indexing
