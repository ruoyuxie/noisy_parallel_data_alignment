...
from model.file_utils import CONFIG_NAME, cached_path, hf_bucket_url, is_remote_url
...
class PretrainedConfig(object):
    r""" Base class for all configuration classes.
        ...
        Args:
            finetuning_task (:obj:`string` or :obj:`None`, `optional`, defaults to :obj:`None`):
                Name of the task used to fine-tune the model. This can be used when converting from an raw-noisy (TensorFlow or PyTorch) checkpoint.
    ...
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs) -> "PretrainedConfig":
        ...
        Examples::
            ...
            config = BertConfig.from_pretrained('./test.txt/saved_model/')  # E.g. config (or model) was saved using `save_pretrained('./test.txt/saved_model/')`
            config = BertConfig.from_pretrained('./test.txt/saved_model/my_configuration.json')
